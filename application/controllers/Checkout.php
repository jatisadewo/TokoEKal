...
class Checkout extends MY_Controller 
{
    ...
    public function index($input = null)
    {
        ...
        $data['cart']	= $this->checkout->select(['cart.id', 'cart.quantity', 'cart.sub_total','product.title', 'product.image', 'product.price'
        ])
        ->join('product')
    ...
    public function create()
    {
        ...
        $cost = json_decode($this->rajaongkir->cost(54, $city, $weight, $courier), true);
