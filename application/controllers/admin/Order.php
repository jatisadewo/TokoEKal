...
{    
	...
	public function cetak_laporan_order()
	{
		$data['order'] = $this->order_model->table('orders');
		
		$this->load->view('pages/admin/order/laporan-print-pinjam', $data);
	}
	...
	public function cetak_resi($id)
	{
		...
		$this->load->view('pages/admin/order/cetak_resi', $data);
		...
		$dompdf->stream("Resi$id.pdf", array('Attachment' => 0));
		// echo'<pre>';
		// print_r($data);
	}
}
