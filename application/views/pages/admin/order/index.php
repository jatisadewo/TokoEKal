<div class="card shadow my-3">
    ...
    <div class="card-body">
        <div class="row my-2">
            ...
            <a target="_blank" href="<?= base_url('cetak/cetak_order_pdf'); ?>" class="btn btn-primary mb-3"><i class="fas fa-print"></i> </a>
            <a target="_blank" href="<?= base_url('cetak/cetak_order_pdf'); ?>" class="btn btn-warning mb-3"><i class="far fa-file-pdf"></i> </a>
            <a target="_blank" href="<?= base_url('cetak/export_excel'); ?>" class="btn btn-success mb-3"><i class="far fa-file-excel"></i> </a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a target="_blank" href="<?= base_url("admin/order/cetak_resi/$row->id") ?>" class="btn btn-sm btn-secondary">Cetak Resi</a>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
