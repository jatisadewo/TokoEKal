...
<head>
	<meta charset="UTF-8">
	<title><?= isset($title) ? $title : 'TOKOEKAL' ?> TOKOEKAL</title>
			...
			<div class="container">
				<div class="row py-4">
					<div class="col-lg-4 col-sm-12 mb-3">
						<h4>Kontak</h4>
						<p class="mt-4">
							Jln Tridaya Nuansa No. 3, Tambun Selatan, Bekasi
							<br><br>
							WA: +62 858 6599 3937 <br>
							MAIL: tokoekal@gmail.com
						</p>
					</div>
					<div class="col-lg-4 col-sm-12 mb-3">
						<h4>Bantuan</h4>
				...
				<div class="container mt-3">
					<div class="row">
						<div class="col-lg-6 col-sm-12">
							<p>&copy; 2023 All Reserved TokoEkal</p>
						</div>
						<div class="col-lg-6 col-sm-12">
